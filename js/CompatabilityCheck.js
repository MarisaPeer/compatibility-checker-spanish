...
if(PluginDetect.browser.isChrome == 1){
	...
	document.write("Navegador web Firefox" + ".<br><b>Consejo</b>: Descarga e instala Google Chrome dando <a href='https://www.google.co.uk/chrome' target='_blank'>clic aquí</a>.</td><td class= 'alert alert-warning'></td>");
		}
	else if (PluginDetect.browser.isIE == 1){
	document.write("Navegador web Internet Explorer" + ".<br><b>Consejo</b>: Descarga e instala Google Chrome dando <a href='https://www.google.co.uk/chrome' target='_blank'>clic aquí</a>.</td><td class= 'alert alert-warning'></td>");
		}
	else if (PluginDetect.browser.isSafari == 1){
	document.write("Navegador web Safari" + ".<br><b>Consejo</b>: Descarga e instala Google Chrome dando <a href='https://www.google.co.uk/chrome' target='_blank'>clic aquí</a>.</td><td class= 'alert alert-warning'></td>");
		}
	else 
	document.write ("Navegador web no identificado" + ".<br><b>Consejo</b>: Descarga e instala Google Chrome dando <a href='https://www.google.co.uk/chrome' target='_blank'>clic aquí</a>.</td><td class='warning'></td>");
...
function checkPopup(){
 ...
 if(mine){
    document.write("Las pantallas emergentes no están bloqueadas.</td><td class= 'alert alert-success'></td>");
		}
 else
 	{
    document.write("Las pantallas emergentes están bloqueadas.<br><b>Consejo</b>: Ve a la configuración de tu navegador web y habilita las pantallas emergentes.</td><td class= 'alert alert-warning'></td>");
}
 mine.close();
}
...
var tmpcookie = new Date();   chkcookie = (tmpcookie.getTime() + '');   document.cookie = "chkcookie=" + chkcookie + "; path=/";
  if (document.cookie.indexOf(chkcookie,0) < 0) {
     document.write ("Las cookies no están habilitadas.<br><b>Consejo</b>: Ve a la configuración de tu navegador web y habilita las cookies.</td><td class= 'alert alert-danger'></td>");
	     }    
else
		  {
document.write ("Las cookies están habilitadas.</td><td class= 'alert alert-success'></td>");
		    }
}
...
{
	document.write('Resolución ' + screen.width + 'x'+ screen.height + ".</td><td class= 'alert alert-success'></td>");
}
else
	document.write('Resolución (' + screen.width + 'x'+ screen.height + ").</td><td class= 'alert alert-warning'></td>");
}